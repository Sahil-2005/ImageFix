...
const docs = [
  { slug: 'neet-photo-resize', title: 'NEET', w: 413, h: 531, min: 10, max: 200, cat: 'exam-india' },
  { slug: 'jee-main-photo', title: 'JEE Main', w: 413, h: 531, min: 10, max: 200, cat: 'exam-india' },
  { slug: 'gate-photo-resize', title: 'GATE Photo', w: 480, h: 640, min: 20, max: 200, cat: 'exam-india' },
  { slug: 'gate-signature', title: 'GATE Signature', w: 530, h: 260, min: 5, max: 200, cat: 'signature' },
  { slug: 'ibps-po-photo', title: 'IBPS PO', w: 200, h: 230, min: 20, max: 50, cat: 'exam-india' },
  { slug: 'ibps-clerk-photo', title: 'IBPS Clerk', w: 200, h: 230, min: 20, max: 50, cat: 'exam-india' },
  { slug: 'ibps-signature', title: 'IBPS Signature', w: 140, h: 60, min: 10, max: 20, cat: 'signature' },
  { slug: 'rrb-ntpc-photo', title: 'RRB NTPC', w: 320, h: 240, min: 20, max: 50, cat: 'exam-india' },
  { slug: 'rrb-alp-photo', title: 'RRB ALP', w: 320, h: 240, min: 20, max: 50, cat: 'exam-india' },
  { slug: 'rrb-signature', title: 'RRB Signature', w: 140, h: 60, min: 10, max: 40, cat: 'signature' },
  { slug: 'ssc-chsl-photo', title: 'SSC CHSL', w: 200, h: 240, min: 20, max: 50, cat: 'exam-india' },
  { slug: 'ssc-mts-photo', title: 'SSC MTS', w: 200, h: 240, min: 20, max: 50, cat: 'exam-india' },
  { slug: 'ssc-signature', title: 'SSC Signature', w: 140, h: 60, min: 10, max: 20, cat: 'signature' },
  { slug: 'uk-passport-photo', title: 'UK Passport', w: 600, h: 750, min: 50, max: 10000, cat: 'passport' },
  { slug: 'uk-visa-photo', title: 'UK Visa', w: 413, h: 531, min: 50, max: 240, cat: 'visa' },
  { slug: 'schengen-visa-photo', title: 'Schengen Visa', w: 413, h: 531, min: 20, max: 240, cat: 'visa' },
  { slug: 'canada-pr-photo', title: 'Canada PR', w: 420, h: 540, min: 60, max: 240, cat: 'visa' },
  { slug: 'canada-visa-photo', title: 'Canada Visa', w: 420, h: 540, min: 60, max: 240, cat: 'visa' },
  { slug: 'australia-visa-photo', title: 'Australia Visa', w: 413, h: 531, min: 50, max: 500, cat: 'visa' },
  { slug: 'indian-passport-photo', title: 'Indian Passport', w: 630, h: 810, min: 20, max: 100, cat: 'passport' },
  { slug: 'aadhaar-card-photo', title: 'Aadhaar Card', w: 300, h: 400, min: 20, max: 50, cat: 'identity-india' },
  { slug: 'pan-card-uti-photo', title: 'PAN Card (UTI)', w: 213, h: 213, min: 10, max: 30, cat: 'identity-india' },
  { slug: 'pan-card-uti-signature', title: 'PAN Card Signature (UTI)', w: 400, h: 200, min: 10, max: 60, cat: 'signature' },
  { slug: 'oci-card-photo', title: 'OCI Card', w: 600, h: 600, min: 20, max: 200, cat: 'identity-india' },
];
