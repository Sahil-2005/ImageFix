...
<ToolCTA
  toolName="Compress & Strip Metadata"
  description="Remove all hidden metadata from your photos instantly. GPS location, device info, timestamps — all stripped automatically when you compress or convert through ImageFix. Zero upload, 100% private."
